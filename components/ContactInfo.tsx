...
export const whatsappNumber = "5551998556268"

export default function Contact() {

  const instagramUser = "zolincorteclube" 
  const address = "R. Alfredo Emilio Allen, 360 - Salgado Filho, Gravataí - RS"
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-xl font-bold group-hover:text-primary transition-colors">(51) 99855-6268</p>
                </div>
              </a>
          ...
          <div className="w-full lg:w-1/2 h-[450px] relative group">
            ...
            <div className="relative z-10 w-full h-full bg-zinc-900 overflow-hidden rounded-sm grayscale invert contrast-[0.9] hover:grayscale-0 transition-all duration-700">
               <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d27658.79247349443!2d-51.02795898914335!3d-29.940636795131603!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95190bcf66860077%3A0x1ea9fe4179eff6a!2sZolin%20Corte%20Clube!5e0!3m2!1spt-BR!2sbr!4v1770663478309!5m2!1spt-BR!2sbr" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
